...
var map = {
	"./add-sale-item/add-sale-item.module": [
	...
	"./receive-item/receive-item.module": [
		"./src/app/receive-item/receive-item.module.ts",
		"receive-item-receive-item-module"
	],
	"./return-item/return-item.module": [
		"./src/app/return-item/return-item.module.ts",
		"return-item-return-item-module"
	],
	"./scan-item/scan-item.module": [
	...
	"./view-inventory/view-inventory.module": [
...
var ApiService = /** @class */ (function () {
    function ApiService(http, toastController, loadingCtrl) {
        this.http = http;
        this.toastController = toastController;
        this.loadingCtrl = loadingCtrl;
        this.baseUrl = 'http://67.79.237.242/opal/uat/KBC/';
        //baseUrl :string = 'https://www2.order-fulfillment.bz/kbc/';
        //Login
        this.userLogin = 'userApi/userLogin';
        this.modalList = "itemsapi/GetAllItemListApi";
        //Return Item
        this.conditionDrop = "itemsapi/getreturnitemconditonenumList";
        this.reasonDrop = "itemsapi/getreturnitemreasonenumList";
        this.modelSearch = "itemsapi/getautoitemlist";
        this.saveReturnItem = "itemsapi/savereturnitemdetail";
        this.serialScan = "itemsapi/getreturnitemdetail";
        // serialVerify: string = "itemsapi/serialNumberValidation";//No need to validate 
        //Receive Item
        this.saveReceive = "itemsapi/savereceiveitemdetail";
        this.receiveSerialScan = "itemsapi/ReceiveItemSerialNumberVerification";
        //Scan order
        this.orderScan = "ordersapi/getscanorderdetail";
        this.saveOrder = "ordersapi/SaveScanOrderDetail";
        this.verifySerial = "ordersapi/VerifySerialNumber";
        //Add sale
        this.scanSerial = "itemsapi/AddSaleItemSerialNumberVerification";
        this.saleSave = "itemsapi/SaveAddSaleItem";
        //View Inventory
        this.viewInventory = "itemsapi/viewinventory";
        this.userId = localStorage.getItem("Id");
        this.allModelLists = [];
    }
    ApiService.prototype.presentToast = function (msg, color) {
    ...
    ApiService.prototype.present = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ApiService.prototype.dismiss = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
...
* @param dataParam
*/
    ApiService.prototype.ajaxCallService = function (dataUrl, dataType, dataParam) {
        var _this = this;
        ...
        switch (dataType) {
            case 'get': return new Promise(function (resolve) {
                _this.http.get(dataUrl)
                    .subscribe(function (data) {
                    _this.ajaxData = data;
                    resolve(_this.ajaxData);
                }, function (err) {
                    _this.err = err.error;
                    _this.presentToast('Unable to reach server, Please try again', 'danger');
                    resolve(_this.err);
                });
            });
            case 'post': return new Promise(function (resolve) {
                // this.presentLoading();
                _this.http.post(dataUrl, dataParam, { headers: headers })
                    .subscribe(function (data) {
                    _this.ajaxData = data;
                    resolve(_this.ajaxData);
                }, function (err) {
    ...
    ApiService.prototype.getAllModelList = function () {
        var _this = this;
        var url = this.baseUrl + this.modalList;
        this.allModelLists = [];
        this.ajaxCallService(url, "post", "").then(function (result) {
            var res = result;
            for (var i in res) {
                if (res[i]['modelNumber'] != undefined) {
                    _this.allModelLists.push(res[i]['modelNumber']);
                }
            }
        });
    };
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, router, opalService) {
...
/* harmony import */ var _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ionic-native/native-audio/ngx */ "./node_modules/@ionic-native/native-audio/ngx/index.js");
...
module.exports = __webpack_require__(/*! /Users/viveknath/Documents/Opal_Kbc/src/main.ts */"./src/main.ts");
